namespace TarnishedTool.Memory
{
        ...
        int instructionLength = 0)
    {
        ...
        public static readonly Pattern FieldArea = new(
            [
                0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x00, 0x48, 0x85, 0xC0, 0x74, 0x2B, 0x8B, 0x80, 0xE8, 0x00, 0x00,
                0x00
            ],
            "xxx????xxxxxxxxxxx",
            0,
        ...
        public static readonly Pattern GetEvent = new(
            [0xE8, 0x00, 0x00, 0x00, 0x00, 0x85, 0xC0, 0x40, 0x0F, 0x95, 0xC6, 0x40, 0x84, 0xED, 0x48, 0x8B, 0x6C, 0x24, 0x30],
            "x????xxxxxxxxxxxxxx",
            0,
            AddressingMode.Relative,
            1,
