namespace TarnishedTool.Memory
{
        ...
        int anchorOffset = -1)
    {
        ...
        public static readonly Pattern FD4PadManager = new(
            [
                0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x00, 0x41, 0x8B, 0xF9, 0x41, 0x8B, 0xE8, 0x48, 0x8B, 0xDA, 0x48,
                0x8B, 0xF1, 0x48, 0x85, 0xC0, 0x75, 0x2E
            ],
        ...
        public static readonly Pattern CSDbgEvent = new(
            new byte[]
            {
                0x48, 0x8B, 0x08, 0x8B, 0x85, 0xE0, 0x00, 0x00, 0x00, 0x89, 0x45, 0xE0, 0x48, 0x89, 0x4D, 0xE8, 0x88,
                0x5C, 0x24, 0x20, 0x4C, 0x8D, 0x4D, 0xE0, 0x45, 0x33, 0xC0, 0x48, 0x8D, 0x55, 0x48, 0x48, 0x8D, 0x4C,
                0x24, 0x50, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8B, 0x0D, 0x00, 0x00, 0x00, 0x00
            },
        ...
        public static readonly Pattern CSSound = new Pattern(
            [
                0xC7, 0x44, 0x24, 0x58, 0x02, 0x00, 0x00, 0x00, 0x89, 0x74, 0x24, 0x5C, 0x48, 0x8B, 0x44, 0x24, 0x58,
                0x48,
        ...
        public static readonly Pattern GetForceActIdx = new(
            [
                0x48, 0x8B, 0x41, 0x08, 0x0F, 0xBE, 0x80, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8D, 0x64, 0x24, 0x08, 0xFF,
                0x64, 0x24, 0xF8
            ],
            "xxxxxxx??xxxxxxxxxxx",
            4,
        ...
        public static readonly Pattern TargetNoStagger = new Pattern(
            new byte[]
            {
                0x48, 0x8B, 0x41, 0x08, 0x83, 0x48, 0x2C, 0x08, 0x0F, 0x28, 0xBC, 0x24, 0xB0, 0x00, 0x00, 0x00, 0x48,
                0x81, 0xC4, 0xD0, 0x00, 0x00, 0x00, 0x5F, 0x5E, 0x5B, 0xC3
            },
        ...
        public static readonly Pattern SpeedyBuff = new Pattern(
            new byte[]
            {
                0x48, 0x8B, 0x47, 0x18, 0xF3, 0x0F, 0x11, 0x40, 0x14, 0xF3, 0x0F, 0x10, 0x43, 0x0C, 0xF3, 0x0F, 0x11,
                0x44,
                0x24, 0x20, 0xF3, 0x0F, 0x10, 0x5B, 0x08, 0xF3, 0x0F, 0x10, 0x53, 0x04, 0x49, 0x8B, 0xD6, 0x48, 0x8B,
                0x4F,
                0x18
            },
        ...
        public static readonly Pattern ExternalEventTempCtor = new(
            [
                0x48, 0x8B, 0xC1, 0xC7, 0x41, 0x10, 0x02, 0x00, 0x00, 0x00, 0x89, 0x51, 0x08, 0x48, 0xC7, 0x81, 0xE0,
                0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC3
            ],
            "xxxxxxxxxxxxxxxxxxxxxxxxx",
            -10,
            AddressingMode.Absolute,
        ...
        public static readonly Pattern CloseMap = new(
            [
                0xFF, 0x50, 0x60, 0x48, 0x8D, 0x8B, 0xD8, 0x27, 0x00, 0x00, 0x66, 0xC7, 0x83, 0x44, 0x0A, 0x00, 0x00,
                0x00, 0x00, 0xC6, 0x83, 0x46, 0x0A, 0x00, 0x00, 0x00
            ],
            "xxxxxxxxxxxxxxxxxxxxxxxxxx",
            0,
            AddressingMode.Absolute,
